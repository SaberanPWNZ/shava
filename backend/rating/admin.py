...
class AchievementAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("name", "description", "icon", "is_active")}),
        ("Criteria", {"fields": ("reviews_required",)}),
    )
...
class UserRatingAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("User", {"fields": ("user",)}),
        ("Statistics", {"fields": ("total_reviews", "average_score_given")}),
        ("Progress", {"fields": ("level", "experience_points")}),
        (
            "Timestamps",
